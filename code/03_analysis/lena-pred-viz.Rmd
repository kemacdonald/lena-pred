...
save_plot(here(fname), f0_pred_plot, ncol = 1.2, nrow = 1.5)

f0_pred_plot
```

Deprecated plotting code (for showing variations across experimental runs)
...
temporal_plot_collapsed <- ms %>%   
  ...
  geom_pointrange(aes(ymin = ci_lower, ymax = ci_upper),
                  position = position_dodge(0.1), size = 0.7) +
  ylim(0, NA) +
