...
```{r}
d_list <- read_rds(here(paths_config$lstm_sum_path, "lena-pred-lstm-preds.rds"))
d_persist <- read_csv(here(paths_config$lstm_sum_path, "lena-pred-persist-results-mb.csv"))
```
...
d_kmeans <- read_rds(here(paths_config$pitch_sum_path, "lena-pred-kmeans-outputs.rds"))
shape_val <- "shapes_8"
